...
const MainContents = ({ translations }: MainSolutionsProps) => {
              ...
              <Box>
                ...
                <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
                  ...
                  >
                    ...
                    <AccordionDetails>
                      <Typography>{t("Section4 Item1 Description")}</Typography>
                    </AccordionDetails>
                  </Accordion>
                  <Accordion
                  ...
                  >
                    ...
                    <AccordionDetails>
                      <Typography>{t("Section4 Item2 Description")}</Typography>
                    </AccordionDetails>
                  </Accordion>
                  <Accordion
                  ...
                  >
                    ...
                    <AccordionDetails>
                      <Typography>{t("Section4 Item3 Description")}</Typography>
                    </AccordionDetails>
                  </Accordion>
                </Box> 
              </Box>
          ...
          <Box sx={{ minHeight: "60vh", pb: 2 }}>
            ...
            <Grid container spacing={3} sx={{ alignItems: "center" }}>
              <Grid item xs={12} sm={6} md={4} lg={3}>
                <Card
                  sx={{ maxWidth: { xs: "100%", md: 345 }, background: theme.palette.palette_style.background.paper }}
                  onClick={async () => {
                    let link = t("Section5 Item1 Link");
                    if (!isExisting) link = link.replace("/existing", "");
                    if (link && !link.startsWith("Section5 ")) {
                      await router.push({ pathname: link });
                    }
                  }}
                >
                  <CardActionArea>
              ...
              <Grid item xs={12} sm={6} md={4} lg={3}>
                <Card
                  sx={{ maxWidth: { xs: "100%", md: 345 }, background: theme.palette.palette_style.background.paper }}
                  onClick={async () => {
                    let link = t("Section5 Item2 Link");
                    if (!isExisting) link = link.replace("/existing", "");
                    if (link && !link.startsWith("Section5 ")) {
                      await router.push({ pathname: link });
                    }
              ...
              <Grid item xs={12} sm={6} md={4} lg={3}>
                <Card
                  sx={{ maxWidth: { xs: "100%", md: 345 }, background: theme.palette.palette_style.background.paper }}
                  onClick={async () => {
                    let link = t("Section5 Item3 Link");
                    if (!isExisting) link = link.replace("/existing", "");
                    if (link && !link.startsWith("Section5 ")) {
                      await router.push({ pathname: link });
                    }
              ...
              <Grid item xs={12} sm={6} md={4} lg={3}>
                <Card
                  sx={{ maxWidth: { xs: "100%", md: 345 }, background: theme.palette.palette_style.background.paper }}
                  onClick={async () => {
                    let link = t("Section5 Item4 Link");
                    if (!isExisting) link = link.replace("/existing", "");
                    if (link && !link.startsWith("Section5 ")) {
                      await router.push({ pathname: link });
                    }
