...
const TextareaSettings = ({
  ...
  const { isWidgetTextArea } = isWidget;
  ...
  if (!openPanel || !isWidgetTextArea) return null;

  return (
    <>
      <Typography variant="h6" component="h3" mb={2}>
        {t('Long Text Properties')}
      </Typography>
      <Box mb={2}>
        <InputNameSetting
          label={t("Field Label")}
...
export default connect(mapStateToProps, mapDispatchToProps)(TextareaSettings);
