...
const SwitchRoleLabels = ({ id, rights, setRights, translations }: any) => {
  ...
  const handleOperations = useCallback(() => {
    setState((prevState) => {
      const newOperationsObject: any = { ...prevState };
      Object.keys(newOperationsObject).forEach((key) => {
        newOperationsObject[key] = rights.includes(key);
      });
      return newOperationsObject;
    });
  }, [rights]);
...
export default memo(SwitchRoleLabels);
