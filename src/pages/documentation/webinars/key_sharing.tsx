...
import MainContents from "src/components/documentation/webinars/key-sharing/MainContents";
import Head from 'next/head';

type WebinarsKeySharingProps = {
  translations: TranslationText[];
};

const WebinarsKeySharing = ({
  translations
}: WebinarsKeySharingProps) => {
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  return await getTranslations("webinars key sharing", context);
}

export default WebinarsKeySharing;
