...
import MainContents from "src/components/documentation/webinars/inviting-users/MainContents";
import Head from 'next/head';

type WebinarsInvitingUsersProps = {
  translations: TranslationText[];
};

const WebinarsInvitingUsers = ({
  translations
}: WebinarsInvitingUsersProps) => {
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  return await getTranslations("webinars inviting users", context);
}

export default WebinarsInvitingUsers;
