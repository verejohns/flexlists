...
import MainContents from "src/components/documentation/webinars/list-sharing/MainContents";
import Head from 'next/head';

type WebinarsListSharingProps = {
  translations: TranslationText[];
};

const WebinarsListSharing = ({
  translations
}: WebinarsListSharingProps) => {
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  return await getTranslations("webinars list sharing", context);
}

export default WebinarsListSharing;
