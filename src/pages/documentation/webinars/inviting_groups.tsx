...
import MainContents from "src/components/documentation/webinars/inviting-groups/MainContents";
import Head from 'next/head';

type WebinarsInvitingGroupsProps = {
  translations: TranslationText[];
};

const WebinarsInvitingGroups = ({
  translations
}: WebinarsInvitingGroupsProps) => {
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  return await getTranslations("webinars inviting groups", context);
}

export default WebinarsInvitingGroups;
