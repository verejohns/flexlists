...
import MainContents from "src/components/documentation/webinars/adding-new-list/MainContents";
import Head from 'next/head';

type WebinarsAddingNewListProps = {
  translations: TranslationText[];
};

const WebinarsAddingNewList = ({
  translations
}: WebinarsAddingNewListProps) => {
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  return await getTranslations("webinars adding new list", context);
}

export default WebinarsAddingNewList;
