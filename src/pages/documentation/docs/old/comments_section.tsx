...
import MainContents from "src/components/documentation/docs/comments-section/MainContents";
import Head from 'next/head';

type DocsCommentsSectionProps = {
  translations: TranslationText[];
};

const DocsCommentsSection = ({
  translations
}: DocsCommentsSectionProps) => {
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  return await getTranslations("docs comments section", context);
}
