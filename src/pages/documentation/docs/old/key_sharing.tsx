...
import MainContents from "src/components/documentation/docs/key-sharing/MainContents";
import Head from 'next/head';

type DocsKeySharingProps = {
  translations: TranslationText[];
};

const DocsKeySharing = ({
  translations
}: DocsKeySharingProps) => {
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  return await getTranslations("docs key sharing", context);
}

export default DocsKeySharing;
