...
import MainContents from "src/components/documentation/docs/creating-new-view/MainContents";
import Head from 'next/head';

type DocsCreatingNewViewProps = {
  translations: TranslationText[];
};

const DocsCreatingNewView = ({
  translations
}: DocsCreatingNewViewProps) => {
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  return await getTranslations("docs creating new view", context);
}

export default DocsCreatingNewView;
