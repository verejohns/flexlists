...
import MainContents from "src/components/documentation/docs/inviting-groups/MainContents";
import Head from 'next/head';

type DocsInvitingGroupsProps = {
  translations: TranslationText[];
};

const DocsInvitingGroups = ({
  translations
}: DocsInvitingGroupsProps) => {
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  return await getTranslations("docs inviting groups", context);
}

export default DocsInvitingGroups;
