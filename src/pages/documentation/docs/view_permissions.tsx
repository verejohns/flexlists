...
import MainContents from "src/components/documentation/docs/view-permissions/MainContents";
import Head from 'next/head';

type DocsViewPermissionsProps = {
  translations: TranslationText[];
};

const DocsViewPermissions = ({
  translations
}: DocsViewPermissionsProps) => {
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  ...
  return await getTranslations("existing docs view permissions", context);
}

export default DocsViewPermissions;
