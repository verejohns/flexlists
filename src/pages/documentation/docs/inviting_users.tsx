...
import MainContents from "src/components/documentation/docs/inviting-users/MainContents";
import Head from 'next/head';

type DocsInvitingUsersProps = {
  translations: TranslationText[];
};

const DocsInvitingUsers = ({
  translations
}: DocsInvitingUsersProps) => {
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  return await getTranslations("existing docs inviting users", context);
}

export default DocsInvitingUsers;
