...
import MainContents from "src/components/documentation/blogs/adding-new-list/MainContents";
import Head from 'next/head';

type BlogsAddingNewListProps = {
  translations: TranslationText[];
};

const BlogsAddingNewList = ({
  translations
}: BlogsAddingNewListProps) => {
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  return await getTranslations("cominng ", context);
}

export default BlogsAddingNewList;
