...
import MainContents from "src/components/documentation/blogs/inviting-groups/MainContents";
import Head from 'next/head';

type BblogsInvitingGroupsProps = {
  translations: TranslationText[];
};

const BblogsInvitingGroups = ({
  translations
}: BblogsInvitingGroupsProps) => {
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  return await getTranslations("blogs inviting groups", context);
}

export default BblogsInvitingGroups;
