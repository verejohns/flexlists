...
import MainContents from "src/components/documentation/blogs/key-sharing/MainContents";
import Head from 'next/head';

type BlogsKeySharingProps = {
  translations: TranslationText[];
};

const BlogsKeySharing = ({
  translations
}: BlogsKeySharingProps) => {
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  return await getTranslations("blogs key sharing", context);
}

export default BlogsKeySharing;
