...
import MainContents from "src/components/documentation/blogs/inviting-users/MainContents";
import Head from 'next/head';

type BlogsInvitingUsersProps = {
  translations: TranslationText[];
};

const BlogsInvitingUsers = ({
  translations
}: BlogsInvitingUsersProps) => {
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  return await getTranslations("blogs inviting users", context);
}

export default BlogsInvitingUsers;
