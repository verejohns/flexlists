...
import MainContents from "src/components/documentation/blogs/list-sharing/MainContents";
import Head from 'next/head';

type BlogsListSharingProps = {
  translations: TranslationText[];
};

const BlogsListSharing = ({
  translations
}: BlogsListSharingProps) => {
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  return await getTranslations("blogs list sharing", context);
}

export default BlogsListSharing;
