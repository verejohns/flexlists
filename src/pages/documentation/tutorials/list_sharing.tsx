...
import MainContents from "src/components/documentation/tutorials/list-sharing/MainContents";
import Head from 'next/head';

type TutorialsListSharingProps = {
  translations: TranslationText[];
};

const TutorialsListSharing = ({
  translations
}: TutorialsListSharingProps) => {
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  return await getTranslations("tutorials list sharing", context);
}

export default TutorialsListSharing;
