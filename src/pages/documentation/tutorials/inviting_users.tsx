...
import MainContents from "src/components/documentation/tutorials/inviting-users/MainContents";
import Head from 'next/head';

type TutorialsInvitingUsersProps = {
  translations: TranslationText[];
};

const TutorialsInvitingUsers = ({
  translations
}: TutorialsInvitingUsersProps) => {
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  return await getTranslations("tutorials inviting users", context);
}

export default TutorialsInvitingUsers;
