...
import MainContents from "src/components/documentation/tutorials/key-sharing/MainContents";
import Head from 'next/head';

type TutorialsKeySharingProps = {
  translations: TranslationText[];
};

const TutorialsKeySharing = ({
  translations
}: TutorialsKeySharingProps) => {
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  return await getTranslations("tutorials key sharing", context);
}

export default TutorialsKeySharing;
