...
import MainContents from "src/components/documentation/tutorials/adding-new-list/MainContents";
import Head from 'next/head';

type TutorialsAddingNewListProps = {
  translations: TranslationText[];
};

const TutorialsAddingNewList = ({
  translations
}: TutorialsAddingNewListProps) => {
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  return await getTranslations("tutorials adding new list", context);
}

export default TutorialsAddingNewList;
