...
interface Custom503Props {
  styles?: any;
}
export default function Custom503({ styles }: Custom503Props) {
        ...
        >
          ...
          >
            ...
            <Typography variant="h4" gutterBottom>
              We are making things works better.
            </Typography>
            <Typography variant="body1" gutterBottom>
              Oopsie! Looks like our server is off, taking a coffee break to whip up some 503 error lattes.<br />
              We promise, we&apos;re brewing up better things!
            </Typography>
